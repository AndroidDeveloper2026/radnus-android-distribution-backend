...
// Get pending approvals (Radnus Employee Login registrations only)
...
exports.approveUser = async (req, res) => {
  try {
    ...
    if (user.role !== 'Radnus') {
      return res.status(400).json({ message: 'Approval is only applicable to Radnus Employee accounts' });
    }
